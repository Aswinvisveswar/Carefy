...
//   await mongoose.connect('mongodb+srv://Aswin:Aswin@cluster0.q47pj.mongodb.net/backend?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
// .then(() => console.log("DB connected"))
// .catch((error) => console.log("error=",error.message)) 
// }
// getconnection()
// mongoose.connect('mongodb+srv://Aswin:Aswin@cluster0.q47pj.mongodb.net/backend?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
// .then(() => console.log("DB connected"))
// .catch((error) => console.log("error=",error.message)) 
// Require all models
...
mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost/carefy');
